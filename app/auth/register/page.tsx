    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#0a0a0f] px-4">
        <div className="card p-8 max-w-sm w-full text-center">
          ...
          <h2 className="text-lg font-semibold text-[#e8e8f0] mb-2">Check your email</h2>
          <p className="text-sm text-[#7a7a9a]">We sent a confirmation link to <strong className="text-[#e8e8f0]">{email}</strong>. Click it to activate your account.</p>
          <Link href="/auth/login" className="btn-primary mt-6 inline-flex justify-center w-full py-2.5">Back to login</Link>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a0f] px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="card p-6">
          <h1 className="text-xl font-semibold text-[#e8e8f0] mb-1">Create your account</h1>
          <p className="text-sm text-[#7a7a9a] mb-6">Free plan — no credit card required</p>

          {error && (
            <div className="mb-4 px-3 py-2.5 rounded-lg bg-red-400/10 border border-red-400/20 text-red-400 text-sm">{error}</div>
          )}
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div>
              ...
              <input type="password" required minLength={6} value={password} onChange={e => setPassword(e.target.value)} placeholder="Min. 6 characters" className="input" />
            </div>
          ...
          <div className="relative my-5">
            ...
            <div className="relative flex justify-center text-xs text-[#7a7a9a]"><span className="bg-[#111118] px-2">or</span></div>
          </div>
          ...
          <p className="text-[11px] text-[#7a7a9a] text-center mt-4">
