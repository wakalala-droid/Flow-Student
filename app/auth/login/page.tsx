    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a0f] px-4 py-8">
      <div className="w-full max-w-sm">
        ...
        <div className="flex items-center gap-3 mb-8 justify-center">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#6c63ff] to-violet-400 flex items-center justify-center text-xl">✦</div>
          <div>
        ...
        <div className="card p-6">
          ...
          <p className="text-sm text-[#7a7a9a] mb-6">Sign in to your account</p>

          {error && (
            <div className="mb-4 px-3 py-3 rounded-lg bg-red-400/10 border border-red-400/20 text-red-400 text-sm">{error}</div>
          )}
          ...
          <div className="relative my-5">
            ...
            <div className="relative flex justify-center text-xs text-[#7a7a9a]">
              <span className="bg-[#111118] px-2">or</span>
            </div>
          </div>

          <button onClick={handleGoogle} className="btn-secondary w-full justify-center py-3 gap-3">
